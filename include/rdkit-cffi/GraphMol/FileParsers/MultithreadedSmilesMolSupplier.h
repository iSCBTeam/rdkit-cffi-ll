...
RDKIT_CFFI_API bool rdkit_multithreaded_smiles_mol_supplier_ctor(rdkit_MultithreadedSmilesMolSupplier *cthis);
RDKIT_CFFI_API bool rdkit_multithreaded_smiles_mol_supplier_ctor_filename(rdkit_MultithreadedSmilesMolSupplier *cthis, const char *filename);
RDKIT_CFFI_API bool rdkit_multithreaded_smiles_mol_supplier_ctor_filename_ex(rdkit_MultithreadedSmilesMolSupplier *cthis, const char *filename, const rdkit_string *delimiter, int32_t smiles_column, int32_t name_column, rdkit_tribool title_line, rdkit_tribool sanitize, size_t num_writer_threads, size_t size_input_queue, size_t size_output_queue);
RDKIT_CFFI_API bool rdkit_multithreaded_smiles_mol_supplier_ctor_istream(rdkit_MultithreadedSmilesMolSupplier *cthis, rdkit_istream *cstream);
RDKIT_CFFI_API bool rdkit_multithreaded_smiles_mol_supplier_ctor_istream_ex(rdkit_MultithreadedSmilesMolSupplier *cthis, rdkit_istream *cstream, const rdkit_string *delimiter, int32_t smiles_column, int32_t name_column, rdkit_tribool title_line, rdkit_tribool sanitize, size_t num_writer_threads, size_t size_input_queue, size_t size_output_queue);
