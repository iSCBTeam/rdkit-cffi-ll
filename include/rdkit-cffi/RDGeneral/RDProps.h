...
RDKIT_CFFI_API void rdkit_rdprops_set_prop_f32(rdkit_RDProps *cthis, const rdkit_string *key, float val);
RDKIT_CFFI_API void rdkit_rdprops_set_prop_f64(rdkit_RDProps *cthis, const rdkit_string *key, double val);
...
RDKIT_CFFI_API bool rdkit_rdprops_get_prop_f32(const rdkit_RDProps *cthis, const rdkit_string *key, float *val);
RDKIT_CFFI_API bool rdkit_rdprops_get_prop_f64(const rdkit_RDProps *cthis, const rdkit_string *key, double *val);
